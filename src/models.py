...
class Member(db.Model):
    ...
    session_bookings = db.relationship(
        'SessionBooking', backref='member', lazy=True)
...
class MemberPlan(db.Model):
    ...
    plan_id = db.Column(db.Integer, db.ForeignKey(
        'membership_plans.id'), nullable=False)
...
class Trainer(db.Model):
    ...
    workout_sessions = db.relationship(
        'WorkoutSession', backref='trainer', lazy=True)
...
class WorkoutSession(db.Model):
    ...
    # Relationships
    session_bookings = db.relationship(
        'SessionBooking', backref='session', lazy=True)
...
class SessionBooking(db.Model):
    ...
    session_id = db.Column(db.Integer, db.ForeignKey(
        'workout_sessions.id'), nullable=False)
