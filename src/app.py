...
def index():
    ...
    upcoming_sessions = WorkoutSession.query.filter(WorkoutSession.session_date >= date.today()).count()
...
def init_db():
    ...
    with app.app_context():
        ...
        if Trainer.query.count() == 0:
            trainers = [
                Trainer(name='Sarah Johnson', specialization='Yoga & Pilates', email='sarah@fitclub.com', phone='555-0101'),
                Trainer(name='Mike Torres', specialization='Strength Training', email='mike@fitclub.com', phone='555-0102'),
                Trainer(name='Emma Davis', specialization='Cardio & HIIT', email='emma@fitclub.com', phone='555-0103')
            ]
